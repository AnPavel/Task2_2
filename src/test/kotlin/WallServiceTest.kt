...
class WallServiceTest {
    ...
    fun add() {
        ...
        var result = false
        val post = Post(0,12, 99, 20221010,"text post 0", "comment content", 0, true,true)
    ...
    fun updateFound() {
        ...
        val post = Post(0,12, 99, 20221010,"text post 0", "comment content", 0, true,true)
        WallService.add(post)
        val postOne = Post(0,22, 99, 20221010,"text post 1", "comment content", 0, true,true)
        WallService.add(postOne)
        val postTwo = Post(0,32, 99, 20221010,"text post 2", "comment content", 0, true,true)
